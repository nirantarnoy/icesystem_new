...
//                        }
    ...
    public function actionFindPricegroup()
    {
        ...
        if ($route_id > 0) {
            ...
            if ($model) {
                $model_prod_price = \common\models\QueryCategoryPrice::find()->where(['delivery_route_id' => $model->delivery_route_id])->groupBy('product_id')->orderBy(['price_group_name' => SORT_ASC, 'product_id' => SORT_ASC])->all();
                if ($model_prod_price) {
