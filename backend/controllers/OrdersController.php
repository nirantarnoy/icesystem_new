        ...
        if ($order_id > 0 && $customer_id > 0) {
            ...
            if ($model) {
                foreach ($model as $value) {
                    ...
                    $html .= '<td style="text-align: center">' . \backend\models\Paymentmethod::findName(0) . '</td>';
                    $html .= '<td style="text-align: center">' . \backend\models\Paymentterm::findName(0) . '</td>';
                    $html .= '<td style="text-align: center"><input type="text" class="form-control" name="line_trans_amt[]" value="' . number_format(0) . '"> </td>';
                    $html .= '<td style="text-align: center">
                                <div class="btn btn-danger btn-sm" data-id="' . $value->id . '" onclick="removepayline($(this))">ลบ</div>
                                <input type="hidden" name="line_trans_id[]" value="' . $value->id . '">
                            </td>';
