...
//            'customer_name',
            ...
            [
                ...
                'value' => function ($data) {
                    return 0;//number_format(\backend\models\Paymentreceive::findPayorderamt($data->id));
                }
            ],
            [
                'label' => 'เครดิต/เชื่อ',
                ...
                'contentOptions' => ['style' => 'text-align: right'],
                'value' => function ($data) {
                    return 0;// number_format(\backend\models\Orders::findordercredit($data->id, $data->sale_from_mobile));
