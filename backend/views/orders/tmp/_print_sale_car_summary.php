...
?>
    ...
    <div id="div1">
        ...
        <form action="<?= \yii\helpers\Url::to(['orders/printcarsummary'], true) ?>" method="post" id="form-search">
        ...
        <table class="table-title" id="table-data" style="width: 100%">
            ...
            ?>
            <?php for ($x= 0;$x<= count($find_user_id)-1;$x++): ?>
                <?php
                $line_route_code = \backend\models\Deliveryroute::findName($find_user_id[$x]);
                ?>

                <tr>
                    <td colspan="7"><b><?= $line_route_code ?></b> </td>
                </tr>
                <?php $find_order = getOrder($from_date, $to_date, 0, $find_user_id[$x], $company_id, $branch_id); ?>
...
//    }
    ...
    $sql.=" GROUP BY t2.order_no, t1.product_id, t1.price";
