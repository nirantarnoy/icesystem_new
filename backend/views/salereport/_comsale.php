...
<table class="table-title" id="table-data">
    <tr>
        <td rowspan="2" style="text-align: center;border-top: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray;border-left: 1px solid gray"><b>สายส่ง</b></td>
        ...
        <td colspan="3" style="text-align: center;border-top: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray"><b>ค่าคอม</b></td>
    </tr>
    <tr>
     ...
     <tr>
        ...
        ?>
             ...
             <tr style="background-color: #d0e9c6">
                 <td colspan="4" style="text-align: left;border-top: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray;border-left: 1px solid gray;text-indent: 50px;"><span> </span> <?=$order_data[$m]['order_date']?></td>
    ...
    <tfoot>
    <tr>
        <td  colspan="4" style="text-align: left;border-top: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray;border-left: 1px solid gray"><b>รวมทั้งหมด</b></td>
        ...
        <td style="text-align: right;border-top: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray"><b><?=number_format($total_com_all,2)?></b></td>
        ...
        <td style="text-align: right;border-top: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray"><b><?=number_format($total_com_sum_all,2)?></b></td>
    </tr>
    </tfoot>
