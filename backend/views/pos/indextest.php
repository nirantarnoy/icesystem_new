    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header modal-header-close-sale" style="background-color: #2b669a">
                ...
                <div class="row" style="text-align: center;width: 100%;color: white">
                    <div class="col-lg-12">
                        <span class="span-before-save"><h3 class="popup-payment" style="color: white"><i class="fa fa-shopping-cart"></i> บันทึกรับเงิน</h3></span>
                        <span class="span-saving" style="display:none;"><img
                                src="<?=\Yii::$app->getUrlManager()->baseUrl.'/loading_gif.gif'?>" style="width:10%" alt=""> <h3 class="popup-payment" style="color: #2b669a">กำลังบันทึกรายการ</h3></span>
                        <input type="hidden" class="popup-product-id" value="">
                        <input type="hidden" class="popup-product-code" value="">
                    </div>
                </div>
