...
/**
 * AssetrentalSearch represents the model behind the search form of `backend\models\Assetrental`.
 */
class AssetrentalSearch extends Assetrental
{
    /**
     * {@inheritdoc}
     */
