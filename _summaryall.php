                    ...
                    if ($data_type_selected == 2) {
                        ...
                        if ($transfer_adjust != null) {
                            if ($transfer_adjust[0]['qty'] != null || $transfer_adjust[0]['qty'] == 0) {
                                ...
                                $line_edit_transfer_color = 'color: green;';
                            }
                        } else {
                    ...
                    if ($data_type_selected == 2) {
                        ...
                        if ($prodrec_adjust != null) {
                            ...
                            if ($prodrec_adjust[0]['qty'] != null || $prodrec_adjust[0]['qty'] == 0) {
                                ...
                                $line_edit_prodrec_color = 'color:green';
...
//        }
        if($data_type_selected == 2){
            $find_shift_2 = $find_shift;
            if($loop == 0){
                $find_shift_2 = $find_shift-1;
            }
            $model_check_before_edit = \common\models\CloseDailyAdjust::find()->where(['product_id'=>$product_id,'shift'=>$find_shift_2,'shift_seq'=>$loop])->one();
            if($model_check_before_edit){
                if($model_check_before_edit->counting_qty!=null){
